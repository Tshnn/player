...
void OpenGLWidget::initializeGL()
{
    ...
    vbo.create();
    vbo.bind();
    vbo.allocate(vertices, sizeof(vertices)); // 顶点数据拷贝到VBO中

    program = new QOpenGLShaderProgram(this); // 创建一个着色器程序
...
void OpenGLWidget::paintGL()
{
    ...
    // 使用顶点数组方式绘制图形：画连续三角形，对图形进行填充；顶点数组中起始索引为0，绘制4个顶点
...
//    // 把两个着色器附加进去
//    program->addShaderFromSourceCode(QOpenGLShader::Vertex, ":/gl.vert");
//    program->addShaderFromSourceCode(QOpenGLShader::Fragment, ":/gl.frag");
